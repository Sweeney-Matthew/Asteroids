...
#     Matthew Sweeney
# Summary:
#     Rocks fly around. Ship appears and flies correctly. Bullets shoot from gun. Rocks destroy. 
#     Ship crashes when hit. Creates new rocks when hit.
###############################################################
...
#    powerUp.o      Contains all of the Power Up classes
###############################################################
...
powerUp.o: powerUp.cpp powerUp.h flyingObject.h point.h velocity.h uiDraw.h
	g++ -c powerUp.cpp
